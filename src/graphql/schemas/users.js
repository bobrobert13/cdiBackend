...
// BuscarPaciente(data: PacienteInput): [Paciente]
// oneUser: User
...
// const mutations = `
// AddPaciente(data: PacienteInput): Paciente
// AddConsulta(id: ID, data: ConsultaInput): Paciente
// UpdateConsulta(id: ID, idConsulta: ID, data: ConsultaInput): Paciente
